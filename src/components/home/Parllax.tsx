...
const LandingPage = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#FFFAF3] flex items-center justify-center border border-red-500">
      {/* logo */}
          ...
          >
            ...
            {showMask && (
              <motion.div
                ...
                className={`absolute text-black font-normal leading-[100%] tracking-[0%] inset-0 flex items-center justify-center font-sedan ${isMobile ? "text-[54px]" : "md:text-[120px] lg:text-[143px]"
                  }`}
              >
                OLIGARCH
              </motion.div>
